...
class FilemanagerController extends AbstractController
{
    ...
    #[Route('/list', name: 'admin_filemanager_list')]
    ...
    #[Route('/upload', name: 'admin_filemanager_upload')]
    ...
    #[Route('/delete', name: 'admin_filemanager_delete')]
    ...
    #[Route('/create-folder', name: 'admin_filemanager_create_folder')]
